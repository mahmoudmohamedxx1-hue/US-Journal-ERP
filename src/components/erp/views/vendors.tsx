    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-0">
          <div className="grid grid-cols-[6rem_1fr_8rem_8rem_5rem_8rem] items-center gap-2 border-b bg-muted/40 px-3 py-2 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
            <div>Number</div>
            <div>Vendor</div>
            <div>Terms</div>
          ...
          {loading ? (
            ...
            filtered.map((v) => (
              <div key={v.id} className="grid grid-cols-[6rem_1fr_8rem_8rem_5rem_8rem] items-center gap-2 border-b border-border/40 px-3 py-2 text-sm hover:bg-accent/5">
